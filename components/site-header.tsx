    ...
    <header className="flex items-center justify-between px-6 py-3" style={{ backgroundColor: "#6b46c1" }}>
      ...
      <div className="flex items-center gap-2">
        <a
          ...
          className="flex items-center gap-1.5 rounded-lg border border-white/30 bg-white/10 px-3 py-1.5 text-sm font-semibold text-white transition-all hover:border-white/60 hover:bg-white/20"
        >
          <TelegramIcon className="h-4 w-4" />
          <span className="hidden sm:inline">{dict.header.supplier_prices}</span>
        </a>
